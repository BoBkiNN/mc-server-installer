...
from actions import ExpressionProcessor, ActionHandler, DummyActionHandler, UnzipActionHandler, RenameActionHandler
...
class CacheStore:
    ...
    def load(self):
        ...
        if self.cache.version != __version__:
            self.logger.warning(f"Cache is saved with different version ({self.cache.version}). You might expect loading errors")
